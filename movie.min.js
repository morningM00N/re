...
function funcRecords() {
    ...
    try {
        ...
        event.target.innerHTML = words2[0] + "<br><br>" + words2[2] + "<br><br>" + rTime + "<br>H-" + hints
    } catch {
        return
    }
}
...
function funcDraw(e) {
    ...
    for (let f = 0; f < u.length; f++) {
        ...
        for (let $ = 0; $ < u[f][2].length; $++) {
            ...
            if (remainTime != null) {
                i.innerHTML += "<br><br>" + remainTime + "<br>H-" + localStorage.getItem("hbtnHeader_" + f + "_" + $)
            }
